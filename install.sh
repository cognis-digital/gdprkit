#!/usr/bin/env sh
# Universal installer for gdprkit. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/gdprkit.git"
echo "Installing gdprkit ..."
