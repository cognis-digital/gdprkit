...
import argparse, sys
from gdprkit.core import scan, to_json, TOOL_NAME, TOOL_VERSION

def main(argv=None) -> int:
    ap = argparse.ArgumentParser(prog="gdprkit", description="GDPRKIT — Cognis Neural Suite")
    ...
    if args.cmd == "mcp":
        from gdprkit.mcp_server import serve
        return serve()
    if args.cmd == "scan":
