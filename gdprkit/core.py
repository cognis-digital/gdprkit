"""GDPRKIT core — GDPR/CCPA DSAR, RoPA, and cookie-consent toolkit."""
...
RULES = [
    ("GDP-001", "high", "TODO", "Unresolved TODO / placeholder left in input", "Resolve before shipping."),
    ("GDP-002", "medium", "FIXME", "FIXME marker found", "Address the flagged issue."),
    ("GDP-003", "low", "XXX", "XXX marker found", "Review the flagged section."),
]
